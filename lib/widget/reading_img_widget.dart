...
class ReadingImgBlog extends StatelessWidget {
  const ReadingImgBlog({Key? key}) : super(key: key);
    ...
    return Container(
      ...
      child: ListView.builder(
          ...
          itemBuilder: (context, index){
            Booksdata imgBlogList = continueReading[index];
            return Container(
              width: 150,
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          image: AssetImage(imgBlogList.imagePath,),
                          fit: BoxFit.cover,
                        ),
                        boxShadow: [
                          BoxShadow(
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TitleText( colors: Colors.black,title: imgBlogList.bookname, size: 18,fontWeight: FontWeight.w400,),
